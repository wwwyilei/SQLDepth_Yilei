...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--eval_data_path",
                                 ...
                                 default='D:/Datasets/selfvideo/training')
        self.parser.add_argument("--data_path",
                                 type=str,
                                 help="path to the training data",
                                 default='D:/Datasets/selfvideo/training')#os.path.join(file_dir, ".."))
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default="D:/GitHub/SfMNeXt-Impl/model_output"
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", 
                                          "cityscapes_preprocessed", "mc_dataset", "mc_mini_dataset", "nyu_raw","selfvideo"],
                                 default="selfvideo")
        ...
        self.parser.add_argument("--load_pt_folder",
                                 ...
                                 default="D:/GitHub/SfMNeXt-Impl/weights_7")
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="selfvideo",
                                 choices=[
                                    "selfvideo","eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10", "cityscapes"],
